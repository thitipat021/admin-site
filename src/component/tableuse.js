...
export default function Tableuse(records, headCells, filterfunc) {
    ...
    const recordsAfterPagingAndSorting = ()=>{
        return stableSort(filterfunc.fn(records),getComparator(order, orderBy)).slice(page*rowsPerPage, (page+1)*rowsPerPage)
    }
